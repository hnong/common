...
public class ClazzConditionProbability {
    ...
    * @return 给定条件下的类条件概率
    */
    public static float calProxc( String clazz,String item) {
        float ret = 0F;
        float Nxc = CorpusManager.getInstance().getDocCountContainKey(clazz, item);
